...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        navmenu.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int i, long l) {
                if (i == 0){
                    ...
                    Intent wew = new Intent(getBaseContext(), HipsterActivity.class);
                    startActivity(wew);
                }
                onBackPressed();
                return false;
        ...
        BottomNavigationView bottomNavigationView = (BottomNavigationView)
                findViewById(R.id.navigation_main);
    ...
    private void navData() {
        ...
        item.iconImg = R.drawable.ic_nav_latest_news;
        ...
        item.iconImg = R.drawable.ic_rate_us;
        nlistHeader.add(item);
        item = new AdaptorNavbar.ExpandMenu();
        item.iconName = getResources().getString(R.string.rateus);
        item.iconImg = R.drawable.ic_rate_us;
        nlistHeader.add(item);
    }
